<template>
    ...
    <!-- Sider layout -->
      ...
      <div class="al-sidebar">
        ...
        >
          <a-sub-menu key="account">
            <span slot="title"><a-icon type="user" /><span>My profile</span></span>
            <a-menu-item key="1">
      ...
      <!-- Profile information's mapped to Sider layout  -->
      <a-layout style="padding: 12px 12px 12px" class="profile">
        <a-layout-content
